...
def switch_dist_zero(selecao):
    ...
    if selecao == 1:
        lista_zero = (750, 1800, 1250, 1500, 1300, 2900, 2250, 2750, 3690, 4190, 5000, 3750, 3250, 3750, 1995, 3250,
                      ...
                      950, 2135, 1625, 2525, 2045, 1640, 1090, 1215, 1490, 1765, 2200, 2120, 2690, 3120, 3450, 4190,
    ...
    if selecao == 37:
        lista_zero = (730, 500, 485, 420, 0, 1721, 1866, 2791, 4302, 4623, 4890, 3482, 2674, 2570, 1132, 1870, 1149,
                      1543, 897, 1833, 1986, 1107, 1322, 1119, 867, 862, 1171, 844, 1514, 1167, 1300, 1899, 1455, 910,
                      1283, 1022, 300, 2718, 2482, 2295, 2198, 2412, 2431, 2819, 3038, 2686, 3202, 3481, 4301, 4409,
                      3999, 2356, 3379, 1622, 1868, 2320, 2646, 1865)
    if selecao == 38:
        lista_zero = (1995, 1807, 2200, 1368, 1721, 0, 1250, 2222, 4232, 4178, 4190, 2374, 1307, 849, 721, 2117, 1259,
                      860, 1986, 1782, 2089, 2007, 1492, 2724, 2522, 2573, 2835, 1916, 2386, 2210, 2900, 3074, 2462,
                      2608, 2971, 2411, 1928, 2348, 2445, 2553, 2958, 2138, 2964, 3334, 3241, 2727, 3009, 862, 4370,
                      3710, 3370, 760, 2001, 2980, 3348, 3744, 4024, 3223)
    if selecao == 39:
        lista_zero = (2326, 3203, 3152, 2380, 2791, 2222, 1380, 0, 2090, 1978, 2120, 1000, 1308, 2399, 1939, 4155, 3179,
                      3022, 3553, 1009, 1056, 2010, 4072, 3876, 3619, 3534, 3272, 2192, 1986, 2166, 2750, 2638, 2181,
                      3362, 3431, 3800, 3128, 340, 816, 1240, 2011, 3179, 1718, 1909, 1486, 979, 898, 3079, 2279, 1633,
                      1225, 2080, 3938, 2827, 3254, 3422, 3582, 4655)
    if selecao == 40:
        lista_zero = (1670, 2201, 2304, 1421, 1866, 1250, 0, 1380, 3103, 3088, 3190, 1609, 810, 1563, 851, 3047, 2076,
                      1922, 2537, 755, 1054, 1463, 3053, 2984, 2736, 2693, 2657, 1537, 1685, 1677, 2250, 2441, 1842,
                      2617, 2811, 2826, 2203, 1213, 1322, 1505, 2088, 2284, 1970, 2310, 2154, 1610, 1887, 1955, 3239,
                      2704, 2322, 1239, 3023, 2482, 2901, 3211, 3435, 3700)
    if selecao == 41:
        lista_zero = (3599, 4768, 4495, 3995, 4302, 4232, 3103, 2090, 0, 1000, 1818, 2657, 3384, 4494, 3808, 5987, 5035,
                      4985, 5158, 2590, 2355, 3223, 5614, 5203, 4936, 4779, 4234, 3485, 2909, 3249, 3690, 3106, 3059,
                      4526, 4358, 5288, 4620, 1899, 1872, 2001, 2375, 2280, 2021, 1736, 1272, 1626, 1214, 1284, 330,
                      1616, 1483, 4191, 6028, 3460, 3762, 3661, 3637, 6049)
    if selecao == 42:
        lista_zero = (4003, 5071, 4903, 4252, 4623, 4178, 3088, 1978, 1000, 0, 840, 2162, 3101, 4255, 3912, 6119, 5154,
                      5003, 5430, 2792, 2647, 3626, 5932, 5634, 5365, 5239, 4797, 3882, 3408, 3719, 4190, 3773, 3589,
                      5014, 4931, 5639, 4960, 1946, 2147, 2453, 3023, 2993, 2641, 2488, 1926, 1990, 1432, 1100, 1292,
                      738, 750, 3997, 5777, 4094, 4454, 4425, 4453, 6445)
    if selecao == 43:
        lista_zero = (4393, 5329, 5244, 4514, 4890, 4190, 3190, 2120, 1818, 840, 0, 1895, 2966, 4093, 4037, 6226, 5271,
                      5055, 5674, 3092, 3007, 4034, 6192, 5995, 5714, 5614, 5253, 4251, 3880, 4143, 5000, 4356, 4072,
                      5432, 5404, 5929, 5257, 2226, 2552, 2921, 3612, 3638, 3224, 3143, 2562, 2479, 1919, 1496, 2125,
                      450, 898, 3875, 5551, 4635, 5007, 5059, 5119, 6774)
    if selecao == 44:
        lista_zero = (3177, 3799, 3893, 3051, 3482, 2374, 1609, 1000, 2657, 2162, 1895, 0, 1390, 2207, 2420, 4500, 3571,
                      3262, 4112, 1916, 2037, 2906, 4641, 3886, 4349, 3525, 4162, 3045, 2954, 3091, 3750, 3649, 3149,
                      4196, 4316, 4438, 3800, 1368, 1848, 2266, 3034, 3176, 2774, 2917, 2437, 1993, 1726, 1408, 2918,
                      1495, 1350, 2000, 3673, 3807, 4233, 4432, 4602, 5279)
    if selecao == 45:
        lista_zero = (2605, 2917, 3144, 2251, 2674, 1307, 810, 1308, 3384, 3101, 2966, 1390, 0, 1325, 1530, 3428, 2543,
                      2184, 3183, 1605, 1871, 2411, 3719, 2984, 3553, 2698, 3566, 2465, 2612, 2623, 3250, 3364, 2784,
                      3499, 3718, 3551, 2971, 1593, 1939, 2259, 2943, 3106, 2763, 3050, 2741, 2180, 2229, 2107, 3586,
                      2530, 2236, 932, 2677, 3417, 3838, 4123, 4357, 4393)
    if selecao == 46:
        lista_zero = (2824, 2631, 3053, 2228, 2570, 849, 1563, 2399, 4494, 4255, 4093, 2207, 1325, 0, 1537, 2618, 1962,
                      1431, 2758, 2332, 2629, 2775, 3248, 2719, 3368, 2571, 2842, 2717, 3123, 3005, 3750, 3075, 3228,
                      3464, 3829, 3209, 2774, 2644, 2885, 3089, 3629, 3827, 3561, 3905, 3703, 3155, 3310, 3237, 4684,
                      3711, 3392, 200, 1300, 3784, 4171, 4556, 4825, 3982)
    if selecao == 47:
        lista_zero = (1653, 2926, 2546, 2219, 2431, 2964, 1970, 1718, 2021, 2641, 3224, 2774, 2763, 3561, 2308, 4264,
                      3356, 3478, 3302, 1238, 920, 1329, 3705, 3225, 2968, 2802, 2218, 1597, 926, 1292, 1490, 1125,
                      1058, 2534, 2342, 3358, 2734, 1408, 933, 550, 400, 409, 0, 385, 741, 815, 1314, 1782, 1951, 2811,
                      2418, 3208, 4953, 1450, 1784, 1830, 1918, 4062)
    if selecao == 48:
        lista_zero = (1027, 1028, 441, 1278, 910, 2608, 2617, 3362, 4526, 5014, 5432, 4196, 3499, 3464, 2000, 2360,
                      1892, 2361, 1231, 2370, 2410, 1400, 1371, 730, 517, 335, 460, 1180, 1642, 1306, 1205, 1641, 1480,
                      0, 472, 1007, 781, 3217, 2876, 2553, 2217, 2374, 2534, 2868, 3232, 3029, 3575, 3928, 4493, 4926,
                      4516, 3225, 4234, 1267, 1303, 1761, 2056, 1551)
    if selecao == 49:
        lista_zero = (2314, 3530, 3218, 2781, 3038, 3241, 2154, 1486, 1272, 1926, 2562, 2437, 2741, 3703, 2700, 4796,
                      3876, 3895, 3917, 1477, 1194, 1954, 4356, 3911, 3664, 3497, 2951, 2217, 1622, 1965, 2200, 1863,
                      1763, 3232, 3078, 4011, 3360, 1162, 826, 770, 1104, 1066, 741, 600, 0, 590, 741, 1206, 1290, 4776,
                      1810, 3355, 5190, 4776, 2523, 2493, 2554, 4776)
    if selecao == 50:
        lista_zero = (2572, 3659, 3460, 2854, 3202, 3009, 1887, 898, 1214, 1432, 1919, 1726, 2229, 3310, 2587, 4790,
                      3844, 3760, 4040, 1422, 1225, 2217, 4543, 4214, 3938, 3810, 3384, 2464, 2003, 2286, 2690, 2439,
                      2184, 3575, 3523, 4233, 3555, 675, 720, 1023, 1696, 1723, 1314, 1319, 741, 580, 0, 475, 1365,
                      1488, 1079, 2989, 4820, 2720, 3098, 3147, 3242, 5020)
    if selecao == 51:
        lista_zero = (3476, 4432, 4343, 3604, 3999, 3370, 2322, 1225, 1483, 750, 898, 1350, 2236, 3392, 3163, 5385,
                      4424, 4241, 4790, 2194, 2117, 3136, 5307, 5084, 4814, 4709, 4370, 3358, 3011, 3254, 3790, 3521,
                      3186, 4516, 4514, 5037, 4372, 1313, 1668, 2062, 2772, 2818, 2418, 2384, 1810, 1618, 1079, 638,
                      1784, 400, 0, 3158, 4899, 3780, 4165, 4250, 4316, 5870)
    if selecao == 52:
        lista_zero = (2530, 2427, 2808, 1958, 2356, 760, 1239, 2080, 4191, 3997, 3875, 2000, 932, 200, 1270, 2621, 1846,
                      1408, 2636, 1979, 2290, 2451, 3120, 3352, 3164, 3191, 3414, 2416, 2807, 2681, 3300, 3514, 2909,
                      3225, 3547, 3040, 2575, 2318, 2530, 2759, 3284, 3501, 3208, 3560, 3355, 2817, 2989, 2952, 4372,
                      3446, 3158, 0, 1823, 3487, 3880, 4238, 4503, 5014)
    if selecao == 53:
        lista_zero = (1350, 2221, 1610, 2039, 1868, 3348, 2901, 3254, 3762, 4454, 5007, 4233, 3838, 4171, 2623, 3622,
                      3011, 3389, 2501, 2345, 2209, 1450, 2683, 1993, 1819, 1603, 845, 1453, 1273, 1227, 700, 679, 1093,
                      1303, 862, 2314, 1961, 2990, 2524, 2107, 1433, 1489, 1784, 2017, 2523, 2547, 3098, 3533, 3640,
                      4584, 4165, 3880, 5206, 325, 0, 500, 780, 2774)
    if selecao == 54:
        lista_zero = (1273, 1387, 1629, 755, 1132, 721, 851, 1939, 3808, 3912, 4037, 2420, 1530, 1537, 0, 2214, 1300,
                      1160, 1692, 1246, 1518, 1273, 2215, 2240, 2005, 2011, 2152, 1166, 1657, 1477, 1995, 2338, 1741,
                      2000, 2303, 2010, 1423, 1979, 1943, 1961, 2060, 2496, 2308, 2706, 2700, 2202, 2587, 2745, 3920,
                      3562, 3163, 1270, 2700, 2231, 2623, 3015, 3288, 2888)
    if selecao == 55:
        lista_zero = (2642, 1427, 2005, 2039, 1870, 2117, 3047, 4155, 5987, 6119, 6226, 4500, 3428, 2618, 2214, 0, 965,
                      1247, 1118, 3421, 3649, 2961, 1160, 1857, 1886, 2091, 2790, 2705, 3374, 3049, 3250, 3758, 3339,
                      2360, 2827, 1394, 1671, 4202, 4118, 4038, 4077, 4289, 4264, 4674, 4796, 4373, 4790, 4972, 6064,
                      5764, 5385, 2621, 2473, 3461, 3622, 4079, 4406, 1725)
    if selecao == 56:
        lista_zero = (1851, 850, 1471, 1157, 1149, 1259, 2076, 3179, 5035, 5154, 5271, 3571, 2543, 1962, 1300, 965, 0,
                      600, 850, 2455, 2704, 2094, 1306, 1707, 1597, 870, 2265, 1860, 2522, 2212, 2540, 3016, 2515, 1892,
                      2352, 1301, 1115, 3228, 3168, 3104, 3213, 3426, 3356, 3753, 3876, 3421, 3844, 4011, 5114, 4800,
                      4424, 1846, 2343, 2761, 3011, 3481, 3784, 2018)
    if selecao == 57:
        lista_zero = (2121, 1370, 1941, 1408, 1543, 860, 1922, 3022, 4985, 5003, 5055, 3262, 2184, 1431, 1160, 1247,
                      600, 0, 1404, 2438, 2706, 2291, 1823, 2261, 2122, 2235, 2697, 2096, 2706, 2447, 2985, 3308, 2741,
                      2361, 2804, 1839, 1589, 3114, 3120, 3120, 3394, 3605, 3478, 3872, 3895, 3396, 3760, 3872, 5092,
                      4566, 4241, 1408, 1845, 3099, 3389, 3835, 4130, 2567)
    if selecao == 58:
        lista_zero = (1647, 430, 895, 1181, 897, 1986, 2537, 3553, 5158, 5430, 5674, 4112, 3183, 2758, 1692, 1118, 850,
                      1404, 0, 2653, 2833, 1983, 525, 850, 800, 980, 1668, 1707, 2377, 2028, 2200, 2677, 2310, 1231,
                      1715, 437, 590, 3515, 3325, 3164, 3070, 3276, 3302, 3689, 3917, 3548, 4040, 4283, 5197, 5194,
                      4790, 2636, 3197, 2370, 2501, 2979, 3277, 1229)
...
class VetorOrdenado:
    ...
    def imprime(self):
        if self.ultima_posicao == -1:
            ...
            print('0 - ', self.valores[0].vertice.nome, ' - ', self.valores[0].custo, ' - ',
                  self.valores[0].vertice.distancia_objetivo, ' - ', self.valores[0].distancia_aestrela)
    ...
    def buscar(self, atual):
        ...
        if atual == self.objetivo:
            ...
            if self.carruagem is True:
                print(f'Total a pagar pela viagem de carruagem: T${self.preco_viagem}')
        else:
            ...
            if vetor_ordenado.valores[0] is not None:
                ...
                if self.transporte == 3:
                    self.preco_viagem += vetor_ordenado.valores[0].custo
