...
def switch(opcao):
    if opcao == 1:
        ...
        return grafo.Montanhas_uivantes
    elif opcao == 9:
...
print(18*'-', 'CIDADES', 18*'-')
print(f'1 - Valkaria{"8 - Montanhas uivantes":>32}\n2 - Palthar{"9 - Hippiontar":>25}\n3 - Rhond{"10 - Altrim":>24}\n'
      f'4 - Nova Malpetrim{"11 - Nimbarann":>18}\n5 - Barud{"12 - Thartann":>26}\n6 - Yuvalin{"13 - Kannilar":>24}\n'
      f'7 - Zakharin{"14 - Coridrian":>24}')
print(37*'-')
